...
class Self_Attn(nn.Module):
    ...
    def forward(self,x):
        ...
        #proj_attn_value = x.view(m_batchsize,-1,width*height) # B X C X N
        #out_attn = torch.bmm(proj_attn_value,attention.permute(0,2,1) )
        #out_attn = out_attn.view(m_batchsize,C,width,height)
